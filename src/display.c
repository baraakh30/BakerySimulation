...
void draw_bakery_state(void) {
    ...
    for (int team = TEAM_PASTE; team <= TEAM_BREAD; team++) {
        ...
        switch (team) {
            ...
            case TEAM_CAKE: strcpy(team_name, "Cake"); break;
            case TEAM_SANDWICH: strcpy(team_name, "Sandwich"); break;
    ...
    for (int team = TEAM_BAKE_CAKES_SWEETS; team <= TEAM_BAKE_BREAD; team++) {
        char team_name[30];
        switch (team) {
            case TEAM_BAKE_CAKES_SWEETS: strcpy(team_name, "Cakes & Sweets"); break;
            case TEAM_BAKE_PATISSERIES: strcpy(team_name, "Patisseries"); break;
            case TEAM_BAKE_BREAD: strcpy(team_name, "Bread"); break;
            default: strcpy(team_name, "Unknown"); break;
        }
...
void draw_inventory(void) {
    ...
    const Color item_colors[] = {
        COLOR_BREAD, COLOR_CAKE, COLOR_SANDWICH, COLOR_SWEETS,
        COLOR_SWEET_PATISSERIE, COLOR_SAVORY_PATISSERIE, {0.8f, 0.8f, 0.8f}
    };
